...
#define TP_PP_CALL_1_2(fnc,B,...) fnc(B); TP_PP_CALL_1_1(fnc,__VA_ARGS__)
#define TP_PP_CALL_1_3(fnc,C,...) fnc(C); TP_PP_CALL_1_2(fnc,__VA_ARGS__)
#define TP_PP_CALL_1_4(fnc,D,...) fnc(D); TP_PP_CALL_1_3(fnc,__VA_ARGS__)
